...
| 015 | Closed | design       | [codeIntel agent-lsp daemon lifecycle — document TS/Go daemon-broker warm reuse and the in-process jdtls model; defer any spawn-concurrency cap](RDR-015-codeintel-agent-lsp-daemon-lifecycle.md) |
