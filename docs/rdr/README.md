...
| 015 | accepted              | design       | [codeIntel agent-lsp daemon lifecycle — adopt agent-lsp's per-(root,language) daemon-broker for warm start_lsp reuse across spawns, and bound its accumulation](RDR-015-codeintel-agent-lsp-daemon-lifecycle.md) |
