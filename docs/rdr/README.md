...
| 016 | accepted              | design       | [Model and runtime provenance — pinned-source fetch, hash-verified lineage, committed manifest, hooks/skills that make the unverified path the hard path](RDR-016-model-binary-provenance.md) |
